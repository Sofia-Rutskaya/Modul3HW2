...
namespace Modul3HW2
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            phone.Add(new Contact() { FullName = "Dorothy", Number = 92095736 });
            ...
            phone.Add(new Contact() { FullName = "Оля", Number = 236727 });
            phone.Add(new Contact() { FullName = "Антон", Number = 261266227 });
            phone.Add(new Contact() { FullName = "Марта", Number = 261266227 });
